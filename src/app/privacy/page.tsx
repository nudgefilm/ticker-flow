...
const SECTIONS = [
  ...
  {
    title: "개인정보 처리업무 위탁",
    content: `언폴드랩은 서비스 제공을 위해 아래와 같이 개인정보 처리업무를 위탁하고 있습니다.\n· 수탁업체: 포트원 (PortOne, 아임포트)\n· 위탁업무 내용: 전자결제(카드결제, 계좌이체 등) 대행 및 결제 데이터 처리\n· 위탁 기간: 회원 탈퇴 시 또는 위탁계약 종료 시까지\n\n위탁계약 체결 시 관련 법령에 따라 위탁받는 개인정보가 안전하게 관리될 수 있도록 필요한 사항을 규정하고 있습니다.`,
  },
  {
    title: "문의",
