            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-white/[0.06]">
                {displayed.map((t) => {
                  ...
                  return (
                    <tr key={t.id}>
                      <td className="py-2.5 pr-3 tabular-nums text-[#a6a6a6]">{t.date}</td>
                      <td className="py-2.5 pr-3 text-white">{t.name}</td>
                      <td className="py-2.5 pr-3 text-[#a6a6a6]">{t.titleLabel ?? "—"}</td>
                      ...
                      <td className="py-2.5 pr-3 text-right tabular-nums text-[#a6a6a6]">{fmtShares(t.shares)}</td>
                      <td className="py-2.5 text-right tabular-nums text-white">{fmtAmount(t.value)}</td>
                    </tr>
                  );
                })}
              </tbody>
